...
${STUDIO}${buildColourBlock(colour)}`;
...
export function buildReframePrompt({ posePrompt, gender, faceDesc, productDesc, notes, strict = false, roleLines = "", permitted = null, colour = null }) {
...
export function buildRefinePrompt(instruction, { strict = false, roleLines = "", productDesc = "", colour = null } = {}) {
...
FRAMING — ${slotFraming}, on a seamless pure-white background, hex #FFFFFF, with soft even studio lighting, sharp focus, true-to-life colour and material rendering and high detail. No props, no text overlays, no added graphics or logos.${buildColourBlock(colour)}`;
