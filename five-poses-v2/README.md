...
OpenAI is not used anywhere in this app. Generation runs on **Seedream 4.5**
(ByteDance, via fal) and **Nano Banana** (Google Gemini image models), both
chosen because they transfer prints, checks and weaves faithfully instead of
repainting them.
